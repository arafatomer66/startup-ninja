...
class ModulesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('All Kits'), scrolledUnderElevation: 0),
      // No Obx here: the grid builds its tiles lazily, so this builder never
      // touches an observable synchronously and GetX throws. Each tile owns
      // its own Obx instead.
